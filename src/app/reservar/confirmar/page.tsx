...
function ConfirmarContent() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        <h1 className="text-2xl font-bold text-white drop-shadow-md">Confirmar turno</h1>
        <p className="text-sm text-white/80 mt-1">Revisá los datos y completá tu información</p>
      </div>
