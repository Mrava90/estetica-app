...
export async function middleware(request: NextRequest) {
  ...
  const publicPaths = ['/login', '/reset-password', '/auth/confirm', '/reservar', '/api/mis-turnos', '/api/notificar-turno', '/api/reservar/booking', '/api/promociones/activas', '/api/whatsapp/webhook', '/api/cron', '/api/auth/webauthn']
